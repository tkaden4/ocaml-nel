...
(* OASIS_START *)
(* DO NOT EDIT (digest: 66c54a09cf4855716b52e8649d5c3773) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Kaden Thomas"];
          homepage = None;
          bugreports = None;
          synopsis = "A NonEmptyList for OCaml";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\222\215\216r\160\237|\249\1918\180\237*\193\000\r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
